...
import * as require$$2 from 'os';
import require$$2__default from 'os';
...
var config_1 = mainExports.config = DotenvModule.config;
...
config_1();
const availableLogicalCors = require$$2.cpus().length;
class App {
    threadPoolSize;
    constructor(props = {}) {
